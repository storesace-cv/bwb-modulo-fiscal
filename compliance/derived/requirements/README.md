...
Rascunhos em curso (não confirmados):

- [`PROVISIONAL-MATRIX-RM-REQ-001.md`](PROVISIONAL-MATRIX-RM-REQ-001.md) — linhas AO-* provisórias (Citação A–J); **não** há AO-* confirmados
