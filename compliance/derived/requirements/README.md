...
- [`CONFIRMED-MATRIX-RM-REQ-001.md`](CONFIRMED-MATRIX-RM-REQ-001.md) — requisitos com obrigação normativa `confirmed_normative` (hoje: **AO-DOC-002**, **AO-SEQ-001**, **AO-OFF-001**); **≠** homologação AGT
