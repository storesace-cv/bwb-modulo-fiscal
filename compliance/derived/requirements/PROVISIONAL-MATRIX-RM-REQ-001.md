...
| AO-TAX-001 | `partial` | DE 683 Anexo I + Tabelas 2–6 | Ligação preliminar: `taxType`/`taxCode`/`taxExemptionCode` @**19171–19173** + Tabelas 2–6 @**19212–19227** (Citação G). Residual engenharia RM-ENG-003: motor IVA MVP (`internal/taxao`) + testes `AO_TAX_001_*` — ver [`ao-tax-001-engine.md`](../../../docs/01-compliance/ao-tax-001-engine.md). Arredondamento/cálculo normativo completo e DEC-REG-003 **não** fechados; critério do catálogo **não** fica satisfeito só com estas citações. **Não** confirmado |
