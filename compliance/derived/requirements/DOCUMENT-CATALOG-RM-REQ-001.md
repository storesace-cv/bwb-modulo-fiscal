...
| pagamentos | `bwb.ao.pagamentos.ar` | Aviso Cobrança/Recibo (pagamentos) | FE:`AR`; SAFT:`PaymentType=AR` | `Payments` | ambos | Art.3 d)+Art.6 n.º2 b) | nenhuma | pending | distinto de `bwb.ao.vendas.ar` | pending | hipotese | off |
