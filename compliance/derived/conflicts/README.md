...
Perguntas cumulativas à AGT (sanitizadas): [`docs/01-compliance/agt-clarifications-register.md`](../../../docs/01-compliance/agt-clarifications-register.md).
...
| [C-FE-JWS-TYP-001](C-FE-JWS-TYP-001-typ-jwt-vs-jose.md) | Header `typ` JWT vs JOSE nos snapshots FE | aberto (zero wire AGT; AGT-Q-005; RM-FEFIX-003) |
