...
Os PDFs do Diário da República catalogados são **image-only** (`text_extractable: false`). **SRC-B1 concluído:** originais no repositório privado [`storesace-cv/bwb-fiscal-sources-ao`](https://github.com/storesace-cv/bwb-fiscal-sources-ao). **OCR RM-SRC-004 / RM-M2-C concluídos:** 74/19, Rect. 10/19 **v2** (`b3db14e2…`, 3p; gazeta 1948–1949), 683/25 v2 e DP 71/25 (`4931fd3c…`; citar só 11902–11920) com OCR `reviewed` (KB auxiliar). Histórico Rect. incorrecto `77b77f01…` + OCR rejected só em diagnóstico privado (≠ KB). **SRC-B2 concluído:** XSD `SAFTAO1.01_01.xsd` em [`compliance/saft-ao/schemas/`](../../compliance/saft-ao/schemas/) (`pending_validation`). O PDF original permanece a única fonte normativa; OCR `reviewed` **não** confirma requisitos `AO-*` sem citação página a página + revisão compliance.
...
| Decreto Executivo n.º 74/19 + rectificação | 2026-07-26 | 74/19 + Rect. v2 OCR `reviewed` (privado/público metadados); v1 Rect. só diagnostics | Citações AO-* página a página + URL oficial estável |
| Decreto Executivo n.º 683/25 | 2026-07-25 | Original correcto v2 + OCR `reviewed` (`b01e4581…`, 66p; citar 19164–19227) | URL oficial estável; extrair AO-* com citação |
| Decreto Presidencial n.º 71/25 | 2026-07-26 | Fascículo + OCR `reviewed` (`4931fd3c…`); citar 11902–11920 (p.21 = DE 372/25) | Cruzar com AO-SEQ-002; URL oficial estável |
