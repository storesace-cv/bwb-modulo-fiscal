...
**Relaciona:** [`regulatory-gaps.md`](regulatory-gaps.md) · [`open-decisions.md`](../06-delivery/open-decisions.md) · [`official-access-plan.md`](official-access-plan.md) · [`agt-clarifications-register.md`](agt-clarifications-register.md) · [`agt-fe-local-mock.md`](agt-fe-local-mock.md) · `DEC-DEL-002`
