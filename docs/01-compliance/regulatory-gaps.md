...
| GAP-004 | XSD oficial SAF-T (AO) | **Parcialmente mitigado:** XSD ASSOFT + LICENSE/NOTICE (`e9a938e1…`, `pending_validation`); Citação D com elementos/linhas (`InvoiceType` L2023–2065, `References` L1004–1023, `Hash` L1361–1367, `SAFTAOPaymentType` L2740–2754); `doc:Status=Development`; ZIP `local_only` | `AO-SAF-001`, `AO-SAF-002`, gerador/validador | Confirmação AGT + vetores dourados; fecho C-DOC-003 |
