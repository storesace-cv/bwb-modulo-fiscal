...
| Promote schema13 | **RM-OPS-011 CONCLUÍDO** — [rm-ops-011-sandbox-schema13-promotion-report.md](rm-ops-011-sandbox-schema13-promotion-report.md) (`0fbac6a…`; grants; master key fingerprint only) |
