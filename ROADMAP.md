...
| [ ] | RM-REQ-001 | Requisitos AO-* confirmados a partir de fontes oficiais | EM_CURSO | [compliance/derived/conflicts/C-FE-001-fe-endpoint-path-inconsistency.md](compliance/derived/conflicts/C-FE-001-fe-endpoint-path-inconsistency.md) · [internal/fepath/fepath.go](internal/fepath/fepath.go) · [compliance/derived/conflicts/C-SIGN-001-saft-rsa-vs-fe-jws.md](compliance/derived/conflicts/C-SIGN-001-saft-rsa-vs-fe-jws.md) · [compliance/derived/requirements/PROVISIONAL-MATRIX-RM-REQ-001.md](compliance/derived/requirements/PROVISIONAL-MATRIX-RM-REQ-001.md) · 2026-07-28 | citação página a página + revisão compliance | C-FE-001 mitigação `fepath`; C-SIGN-001 `signsep`; **sem** AO-* confirmados |
...
| [ ] | RM-M2-D | M2-D — Requisitos AO-* confirmados | EM_CURSO | [compliance/derived/conflicts/C-FE-001-fe-endpoint-path-inconsistency.md](compliance/derived/conflicts/C-FE-001-fe-endpoint-path-inconsistency.md) · [internal/fepath/fepath.go](internal/fepath/fepath.go) · [compliance/derived/conflicts/C-SIGN-001-saft-rsa-vs-fe-jws.md](compliance/derived/conflicts/C-SIGN-001-saft-rsa-vs-fe-jws.md) · [compliance/derived/requirements/PROVISIONAL-MATRIX-RM-REQ-001.md](compliance/derived/requirements/PROVISIONAL-MATRIX-RM-REQ-001.md) · 2026-07-28 | RM-M2-C + SRC-B2 | C-FE-001 `fepath` + C-SIGN-001/C-DOC mitigação; **sem** AO-* confirmados |
