...
| [ ] | RM-SRC-004 | OCR + MD/TXT dos 3 PDFs image-only (74/19, Rect. 10/19, 683/25) | BLOQUEADO | [https://github.com/storesace-cv/bwb-fiscal-sources-ao/pull/2](https://github.com/storesace-cv/bwb-fiscal-sources-ao/pull/2) · [compliance/catalog/sources.yaml](compliance/catalog/sources.yaml) · [docs/01-compliance/regulatory-gaps.md](docs/01-compliance/regulatory-gaps.md) | Originais correctos Rect. 10/19 + DE 683/25 + OCR `reviewed` dos 3 | 3 diplomas `reviewed`; derivados rejected não são KB |
...
| [ ] | RM-M2-C | M2-C — OCR e revisão visual | BLOQUEADO | [https://github.com/storesace-cv/bwb-fiscal-sources-ao/pull/2](https://github.com/storesace-cv/bwb-fiscal-sources-ao/pull/2) · [compliance/catalog/sources.yaml](compliance/catalog/sources.yaml) · [docs/01-compliance/regulatory-gaps.md](docs/01-compliance/regulatory-gaps.md) | Rect. 10/19 + DE 683/25 originais correctos + 3× OCR `reviewed` | Fail-closed: sem 3 `reviewed` não fecha |
