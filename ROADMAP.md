...
| [ ] | RM-REQ-001 | Requisitos AO-* confirmados a partir de fontes oficiais | EM_CURSO | [compliance/derived/requirements/PROVISIONAL-MATRIX-RM-REQ-001.md](compliance/derived/requirements/PROVISIONAL-MATRIX-RM-REQ-001.md) · [compliance/derived/requirements/FE-SERVICES-MATRIX-RM-REQ-001.md](compliance/derived/requirements/FE-SERVICES-MATRIX-RM-REQ-001.md) · [compliance/derived/requirements/DOCUMENT-TYPES-MATRIX-RM-REQ-001.md](compliance/derived/requirements/DOCUMENT-TYPES-MATRIX-RM-REQ-001.md) · [compliance/derived/requirements/DOCUMENT-CATALOG-RM-REQ-001.md](compliance/derived/requirements/DOCUMENT-CATALOG-RM-REQ-001.md) · [docs/01-compliance/requirements-catalog.md](docs/01-compliance/requirements-catalog.md) | citação página a página + revisão compliance; DEC-REG-003 | DEC-PROD-001–015; catálogo seed+CI; 5 grupos L3; L1≠L2≠L3≠L4; Citação H; AGT-001 `pending_validation`; AGT-002/TAX/SEQ/ID/CRYPTO/DOC-002/OFF `partial`; DOC-001 `scaffold`; SAF `pending_validation`; C-FE-001/C-DOC-003/C-SIGN-001; sem confirmados |
