...
| [x] | RM-AGTPREP-008 | Wizard owner-only preparação AuthorityProfile (3 passos; draft only) | CONCLUÍDO | [internal/adminui/authority_wizard.go](internal/adminui/authority_wizard.go) · [internal/adminui/templates/authority_wizard.html](internal/adminui/templates/authority_wizard.html) · [specs/admin/openapi.yaml](specs/admin/openapi.yaml) · [CHANGELOG.md](CHANGELOG.md) · 2026-07-27 | RM-AGTPREP-003 + RM-BO-011 | Sem activação; external_verified=false; ≠ AGT/plaintext |
| [ ] | RM-AGTPREP-009 | Gate activação fail-closed (active exige config+secrets+offline; nunca external_verified) | PENDENTE | — | RM-AGTPREP-007 + RM-AGTPREP-008 | Simulator≠produção; ≠ AGT |
| [ ] | RM-AGTPREP-010 | Lifecycle/rotação certificados (metadados SecretStore; sem plaintext) | PENDENTE | — | RM-AGTPREP-004 + RM-AGTPREP-005 | ≠ AGT |
