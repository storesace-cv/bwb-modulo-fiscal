...
| [ ] | RM-REQ-001 | Requisitos AO-* confirmados a partir de fontes oficiais | EM_CURSO | [compliance/derived/requirements/PROVISIONAL-MATRIX-RM-REQ-001.md](compliance/derived/requirements/PROVISIONAL-MATRIX-RM-REQ-001.md) · [compliance/derived/requirements/DOCUMENT-TYPES-MATRIX-RM-REQ-001.md](compliance/derived/requirements/DOCUMENT-TYPES-MATRIX-RM-REQ-001.md) · [docs/01-compliance/requirements-catalog.md](docs/01-compliance/requirements-catalog.md) | citação página a página + revisão compliance; DEC-REG-003 | DP71+DE74/Rect+DE683+XSD (Citação D linhas); TAX/SEQ/ID/CRYPTO/DOC-002/OFF `partial`; DOC-001 `scaffold`; SAF-001/002 `pending_validation`; C-DOC-003/C-SIGN-001; sem confirmados |
