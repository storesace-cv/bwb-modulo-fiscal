...
| [ ] | RM-OPS-011 | Promote sandbox `main` → ExpectedVersion=13 + grants schema13 + master key | EM_CURSO | https://github.com/storesace-cv/bwb-modulo-fiscal/pull/154 · [deploy/env.allowlist](deploy/env.allowlist) · [deploy/postgres/grants-schema13-runtime-admin.sql](deploy/postgres/grants-schema13-runtime-admin.sql) · [scripts/deploy/lib/allowlist.sh](scripts/deploy/lib/allowlist.sh) · 2026-07-29 | RM-OPS-006 + RM-AGTPREP-014 | Allowlist SecretStore; default schema 13; promote+grants+report pendentes |
