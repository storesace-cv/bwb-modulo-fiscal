...
| [x] | RM-AGTPREP-005 | Validação offline par chave-cert / cadeia / fingerprint | CONCLUÍDO | [internal/secretstore/offline_validate.go](internal/secretstore/offline_validate.go) · [internal/adminapi/secadm_offline_handlers.go](internal/adminapi/secadm_offline_handlers.go) · [specs/admin/openapi.yaml](specs/admin/openapi.yaml) · [CHANGELOG.md](CHANGELOG.md) · 2026-07-27 | RM-AGTPREP-004 | ≠ external_verified / AGT |
| [ ] | RM-AGTPREP-006 | Adaptador simulador + teste ligação; prod fail-closed | PENDENTE | — | RM-AGTPREP-002 + RM-TX-009 | simulator≠AGT; agt-hml/prd fail-closed |
| [ ] | RM-AGTPREP-007 | Audit/RBAC/métricas + checklist readiness (4 flags) | PENDENTE | — | RM-AGTPREP-002…006 + RM-BO-007 | config/secrets/offline/external_verified=false |
