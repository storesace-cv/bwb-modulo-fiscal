...
| [x] | RM-UI-003 | UI submissões, erros, reconciliação e auditoria | CONCLUÍDO | [internal/adminui/ops.go](internal/adminui/ops.go) · [CHANGELOG.md](CHANGELOG.md) | RM-UI-001 + RM-BO-003 | `/admin/ui/submissions` + `/audit`; sem corpos secretos |
