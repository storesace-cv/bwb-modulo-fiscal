...
| OCR das fontes | BLOQUEADO (faltam Rect. 10/19 e DE 683/25 com originais correctos + OCR `reviewed`) |
...
| [ ] | RM-SRC-004 | OCR + MD/TXT dos 3 PDFs image-only (74/19, Rect. 10/19, 683/25) | BLOQUEADO | [https://github.com/storesace-cv/bwb-fiscal-sources-ao/pull/2](https://github.com/storesace-cv/bwb-fiscal-sources-ao/pull/2) · [compliance/catalog/sources.yaml](compliance/catalog/sources.yaml) · [docs/01-compliance/regulatory-gaps.md](docs/01-compliance/regulatory-gaps.md) | Rect. 10/19 integral oficial + OCR `reviewed` 683/25 v2 + fecho conjunto 74+Rect+683 | 3 diplomas `reviewed`; derivados rejected não são KB; 683 original v2 importado (`b01e4581…`) |
...
| [ ] | RM-M2-C | M2-C — OCR e revisão visual | BLOQUEADO | [https://github.com/storesace-cv/bwb-fiscal-sources-ao/pull/2](https://github.com/storesace-cv/bwb-fiscal-sources-ao/pull/2) · [compliance/catalog/sources.yaml](compliance/catalog/sources.yaml) · [docs/01-compliance/regulatory-gaps.md](docs/01-compliance/regulatory-gaps.md) | Rect. 10/19 integral oficial + OCR `reviewed` 683 v2 + 3× `reviewed` | Fail-closed: sem 3 `reviewed` não fecha; 683 original v2 já no privado |
