...
| [ ] | RM-SRC-003 | Repo privado `storesace-cv/bwb-fiscal-sources-ao` + originais sincronizados | BLOQUEADO | [docs/01-compliance/audits/AUD-B0-SAFTAO-CROSS-PROJECT-REUSE.md](docs/01-compliance/audits/AUD-B0-SAFTAO-CROSS-PROJECT-REUSE.md) · [docs/01-compliance/regulatory-gaps.md](docs/01-compliance/regulatory-gaps.md) | Criação humana do repo privado SRC-B1 | Originais versionados fora de `local/` |
| [ ] | RM-SRC-004 | OCR + MD/TXT dos 3 PDFs image-only (74/19, Rect. 10/19, 683/25) | BLOQUEADO | [compliance/catalog/sources.yaml](compliance/catalog/sources.yaml) · [compliance/POLICY.md](compliance/POLICY.md) | RM-SRC-003; revisão visual `reviewed` | Derivados pesquisáveis aprovados |
| [ ] | RM-SRC-005 | SRC-B2 XSD público/inventário no Git | PENDENTE | [docs/01-compliance/saft-ao.md](docs/01-compliance/saft-ao.md) | RM-SRC-003 | XSD+NOTICE versionados |
...
| [ ] | RM-M2-B | M2-B — Armazenamento sincronizado fontes | BLOQUEADO | [docs/01-compliance/audits/AUD-B0-SAFTAO-CROSS-PROJECT-REUSE.md](docs/01-compliance/audits/AUD-B0-SAFTAO-CROSS-PROJECT-REUSE.md) | Criar `bwb-fiscal-sources-ao` | Repo + originais |
| [ ] | RM-M2-C | M2-C — OCR e revisão visual | BLOQUEADO | [compliance/POLICY.md](compliance/POLICY.md) · [compliance/catalog/sources.yaml](compliance/catalog/sources.yaml) | RM-M2-B | OCR `reviewed` |
