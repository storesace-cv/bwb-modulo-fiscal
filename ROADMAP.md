...
| [ ] | RM-REQ-001 | Requisitos AO-* confirmados a partir de fontes oficiais | EM_CURSO | [compliance/derived/requirements/PROVISIONAL-MATRIX-RM-REQ-001.md](compliance/derived/requirements/PROVISIONAL-MATRIX-RM-REQ-001.md) · [compliance/derived/requirements/FE-SERVICES-MATRIX-RM-REQ-001.md](compliance/derived/requirements/FE-SERVICES-MATRIX-RM-REQ-001.md) · [compliance/derived/conflicts/C-DOC-003-fe-vs-saft-invoice-type.md](compliance/derived/conflicts/C-DOC-003-fe-vs-saft-invoice-type.md) · [internal/doctype/channel_routing.go](internal/doctype/channel_routing.go) · [docs/01-compliance/requirements-catalog.md](docs/01-compliance/requirements-catalog.md) · 2026-07-28 | citação página a página + revisão compliance | Citação H–J; C-DOC-003 mitigação fail-closed; C-DOC-001/002 actualizados; **sem** AO-* confirmados |
...
| [ ] | RM-M2-D | M2-D — Requisitos AO-* confirmados | EM_CURSO | [compliance/derived/requirements/PROVISIONAL-MATRIX-RM-REQ-001.md](compliance/derived/requirements/PROVISIONAL-MATRIX-RM-REQ-001.md) · [compliance/derived/conflicts/C-DOC-003-fe-vs-saft-invoice-type.md](compliance/derived/conflicts/C-DOC-003-fe-vs-saft-invoice-type.md) · [internal/doctype/channel_routing.go](internal/doctype/channel_routing.go) · [docs/01-compliance/requirements-catalog.md](docs/01-compliance/requirements-catalog.md) · 2026-07-28 | RM-M2-C + SRC-B2 | Matriz provisória + C-DOC mitigação; **sem** AO-* confirmados |
