...
| [ ] | RM-REQ-001 | Requisitos AO-* confirmados a partir de fontes oficiais | EM_CURSO | [compliance/derived/requirements/PROVISIONAL-MATRIX-RM-REQ-001.md](compliance/derived/requirements/PROVISIONAL-MATRIX-RM-REQ-001.md) · [compliance/derived/requirements/FE-SERVICES-MATRIX-RM-REQ-001.md](compliance/derived/requirements/FE-SERVICES-MATRIX-RM-REQ-001.md) · [compliance/derived/requirements/DOCUMENT-TYPES-MATRIX-RM-REQ-001.md](compliance/derived/requirements/DOCUMENT-TYPES-MATRIX-RM-REQ-001.md) · [compliance/derived/requirements/DOCUMENT-CATALOG-RM-REQ-001.md](compliance/derived/requirements/DOCUMENT-CATALOG-RM-REQ-001.md) · [docs/01-compliance/requirements-catalog.md](docs/01-compliance/requirements-catalog.md) | citação página a página + revisão compliance; DEC-REG-003 | DEC-PROD-001–015; DEC-DEL-002; catálogo seed+CI; 5 grupos L3; L1≠L2≠L3≠L4; Citação H; AGT-001 `pending_validation`; AGT-002/TAX/SEQ/ID/CRYPTO/DOC-002/OFF `partial`; DOC-001 `scaffold`; SAF `pending_validation`; C-FE-001/C-DOC-003/C-SIGN-001; domínio/API alinhados; sem confirmados |
...
| Check | ID | Entrega | Estado | Evidência | Dependências / gate | Done |
|---|---|---|---|---|---|---|
| [ ] | RM-ENG-001 | Tipos documentais oficiais | BLOQUEADO | [docs/06-delivery/open-decisions.md](docs/06-delivery/open-decisions.md) · [compliance/derived/requirements/DOCUMENT-CATALOG-RM-REQ-001.md](compliance/derived/requirements/DOCUMENT-CATALOG-RM-REQ-001.md) · [docs/01-compliance/regulatory-gaps.md](docs/01-compliance/regulatory-gaps.md) | DEC-PROD-014/015 + DEC-REG-003 + fontes oficiais | Esquema+seed; completar pending; slice faseado |
