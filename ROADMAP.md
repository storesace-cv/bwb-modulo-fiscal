...
| [ ] | RM-FEFIX-008 | Runtime fiscal-api: worker fila fixture + admin enqueue/process | EM_CURSO | [docs/01-compliance/agt-fe-fixture-queue.md](docs/01-compliance/agt-fe-fixture-queue.md) · [internal/authority/fixtruntime/runtime.go](internal/authority/fixtruntime/runtime.go) · [cmd/fiscal-api/main.go](cmd/fiscal-api/main.go) · [CHANGELOG.md](CHANGELOG.md) · 2026-08-19 | RM-FEFIX-007 | Operador usa workbook via serviço; **≠** wire AGT / AGT-Q-003 |
