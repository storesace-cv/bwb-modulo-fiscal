...
| [ ] | RM-REQ-001 | Requisitos AO-* confirmados a partir de fontes oficiais | EM_CURSO | [compliance/derived/requirements/PROVISIONAL-MATRIX-RM-REQ-001.md](compliance/derived/requirements/PROVISIONAL-MATRIX-RM-REQ-001.md) · [compliance/derived/requirements/DOCUMENT-TYPES-MATRIX-RM-REQ-001.md](compliance/derived/requirements/DOCUMENT-TYPES-MATRIX-RM-REQ-001.md) · [docs/01-compliance/requirements-catalog.md](docs/01-compliance/requirements-catalog.md) | citação página a página + revisão compliance; DEC-REG-003 | DP71 Art.10 citado; SEQ-001/DOC-002/OFF-001 `partial`; DOC-001/`TAX` `scaffold`; SAF-001 `pending_validation`; sem confirmados |
