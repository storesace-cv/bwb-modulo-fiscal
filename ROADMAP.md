...
| [ ] | RM-OPS-006 | Promote sandbox `main` → ExpectedVersion=12 + grants schema12 | EM_CURSO | [docs/07-operations/staging-runbook.md](docs/07-operations/staging-runbook.md) · [deploy/postgres/grants-schema12-runtime-admin.sql](deploy/postgres/grants-schema12-runtime-admin.sql) | RM-OPS-002 + main@schema12 | current-sha=health.revision; dirty=false; API 401 sem token; admin fail_closed |
...
| [ ] | RM-BO-018 | Onboarding IdP provider-neutral + readiness diagnostics (sem IdP local inseguro) | EM_CURSO | [docs/07-operations/admin-idp-onboarding.md](docs/07-operations/admin-idp-onboarding.md) · [internal/adminauth/auth_readiness.go](internal/adminauth/auth_readiness.go) | RM-BO-006 + RM-UI-005 | fail_closed até oidc_jwt; interactive login deferred |
