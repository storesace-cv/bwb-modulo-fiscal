...
| [ ] | RM-SRC-004 | OCR + MD/TXT dos 3 PDFs image-only (74/19, Rect. 10/19, 683/25) | BLOQUEADO | [bwb-fiscal-sources-ao@dbae326](https://github.com/storesace-cv/bwb-fiscal-sources-ao/commit/dbae3260df3b8865afd712ffc3e81925a63fb399) · [PR #2](https://github.com/storesace-cv/bwb-fiscal-sources-ao/pull/2) · [compliance/catalog/sources.yaml](compliance/catalog/sources.yaml) · [docs/01-compliance/regulatory-gaps.md](docs/01-compliance/regulatory-gaps.md) | Rect. 10/19 integral oficial + OCR `reviewed` + fecho conjunto 74+Rect+683 | 74/19 e 683/25 v2 `reviewed`; Rect. bloqueia o conjunto; rejected ≠ KB |
...
| [ ] | RM-REQ-001 | Requisitos AO-* confirmados a partir de fontes oficiais | EM_CURSO | [compliance/derived/requirements/PROVISIONAL-MATRIX-RM-REQ-001.md](compliance/derived/requirements/PROVISIONAL-MATRIX-RM-REQ-001.md) · [docs/01-compliance/requirements-catalog.md](docs/01-compliance/requirements-catalog.md) | RM-SRC-005 feito; RM-SRC-004 BLOQUEADO (Rect. 10/19); revisão compliance | SEQ-002/ID-001/CRYPTO `partial`; SAF-001 citation XSD `pending_validation`; Rect.-dependent `blocked`; sem confirmados |
...
| [ ] | RM-M2-C | M2-C — OCR e revisão visual | BLOQUEADO | [bwb-fiscal-sources-ao@dbae326](https://github.com/storesace-cv/bwb-fiscal-sources-ao/commit/dbae3260df3b8865afd712ffc3e81925a63fb399) · [compliance/catalog/sources.yaml](compliance/catalog/sources.yaml) · [docs/01-compliance/regulatory-gaps.md](docs/01-compliance/regulatory-gaps.md) | Rect. 10/19 integral oficial + 3× OCR `reviewed` | Fail-closed: Rect. bloqueia; 74/19 e 683/25 v2 já `reviewed` |
