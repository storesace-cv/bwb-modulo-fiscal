...
| [ ] | RM-REQ-001 | Requisitos AO-* confirmados a partir de fontes oficiais | EM_CURSO | [compliance/derived/requirements/PROVISIONAL-MATRIX-RM-REQ-001.md](compliance/derived/requirements/PROVISIONAL-MATRIX-RM-REQ-001.md) · [docs/01-compliance/requirements-catalog.md](docs/01-compliance/requirements-catalog.md) | RM-SRC-004/005 feitos; citação página a página + revisão compliance | SEQ-002/ID-001/CRYPTO `partial`; DOC/SEQ-001/TAX `scaffold`; SAF-001 `pending_validation`; sem confirmados |
