...
| [x] | RM-ENG-003 | Impostos, taxas, isenções, arredondamentos, descontos, retenções | CONCLUÍDO | [docs/01-compliance/ao-tax-001-engine.md](docs/01-compliance/ao-tax-001-engine.md) · [internal/taxao/calc.go](internal/taxao/calc.go) · [internal/persistence/seal.go](internal/persistence/seal.go) · [CHANGELOG.md](CHANGELOG.md) · 2026-08-19 | RM-REQ-001 · AO-TAX-001 `partial` (DE 683 @19171–19227) | Cálculo IVA MVP testado; **≠** IS/IEC/descontos/retenções confirmados |
