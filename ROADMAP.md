...
| [ ] | RM-SRC-004 | OCR + MD/TXT dos 3 PDFs image-only (74/19, Rect. 10/19, 683/25) | PENDENTE | [compliance/catalog/sources.yaml](compliance/catalog/sources.yaml) · [compliance/POLICY.md](compliance/POLICY.md) | Pipeline OCR + revisão visual `reviewed` | Derivados pesquisáveis aprovados |
...
| [ ] | RM-M2-C | M2-C — OCR e revisão visual | PENDENTE | [compliance/POLICY.md](compliance/POLICY.md) · [compliance/catalog/sources.yaml](compliance/catalog/sources.yaml) | Pipeline OCR + revisão visual | OCR `reviewed` |
