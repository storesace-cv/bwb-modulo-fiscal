...
| [ ] | RM-ARCH-005 | Backoffice operacional (UI) | EM_CURSO | [docs/02-architecture/backoffice-architecture.md](docs/02-architecture/backoffice-architecture.md) · [internal/adminui/ui.go](internal/adminui/ui.go) · [CHANGELOG.md](CHANGELOG.md) | M7 + RM-BO-010 + RM-SECADM-002 + RM-UI-001…004 | SSR monólito; slices UI |
...
| [ ] | RM-UI-002 | UI formulários/mutações + séries/config não secreta | PENDENTE | [docs/02-architecture/backoffice-architecture.md](docs/02-architecture/backoffice-architecture.md) | RM-UI-001 + RM-BO-002 | CSRF; POST/PATCH via SSR |
| [ ] | RM-UI-003 | UI submissões, erros, reconciliação e auditoria | PENDENTE | [docs/02-architecture/backoffice-architecture.md](docs/02-architecture/backoffice-architecture.md) | RM-UI-001 + RM-BO-003 | Read-only ops/audit |
| [ ] | RM-UI-004 | UI SecAdm owner-only (só metadados sanitizados) | PENDENTE | [docs/02-architecture/backoffice-architecture.md](docs/02-architecture/backoffice-architecture.md) | RM-UI-001 + RM-SECADM-003 | Sem plaintext no browser |
...
| [ ] | RM-M7 | M7 — Backoffice operacional mínimo | EM_CURSO | [docs/02-architecture/backoffice-architecture.md](docs/02-architecture/backoffice-architecture.md) · [internal/adminui/ui.go](internal/adminui/ui.go) | M4 + RM-UI-001…004 | Ops mínimas SSR |
