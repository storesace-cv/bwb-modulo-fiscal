...
Registo cumulativo de esclarecimentos AGT (sanitizado): [`docs/01-compliance/agt-clarifications-register.md`](docs/01-compliance/agt-clarifications-register.md).
...
| [x] | RM-OPS-011 | Promote sandbox `main` → ExpectedVersion=13 + grants schema13 + master key | CONCLUÍDO | https://github.com/storesace-cv/bwb-modulo-fiscal/pull/154 · [docs/07-operations/rm-ops-011-sandbox-schema13-promotion-report.md](docs/07-operations/rm-ops-011-sandbox-schema13-promotion-report.md) · [deploy/postgres/grants-schema13-runtime-admin.sql](deploy/postgres/grants-schema13-runtime-admin.sql) · 2026-07-29 | RM-OPS-006 + RM-AGTPREP-014 | current-sha=health.revision; 12→13 dirty=false; grants; master key fingerprint only; ≠ AGT |
...
| [x] | RM-ENG-002 | Séries e numeração conforme AGT | CONCLUÍDO | https://github.com/storesace-cv/bwb-modulo-fiscal/pull/164 · [docs/01-compliance/ao-seq-001-engine.md](docs/01-compliance/ao-seq-001-engine.md) · [internal/persistence/seal_tx.go](internal/persistence/seal_tx.go) · [internal/persistence/seal_test.go](internal/persistence/seal_test.go) · [CHANGELOG.md](CHANGELOG.md) · 2026-08-16 | AO-SEQ-001 `confirmed_normative` (RM-REQ-001) | AO-SEQ-001 contínua/unívoca + corrida; **≠** AO-SEQ-002 / AGT |
...
| [ ] | RM-FE-003 | Séries, registo, consulta, listagem, validação | EM_CURSO | [docs/01-compliance/agt-fe-fixture-queue.md](docs/01-compliance/agt-fe-fixture-queue.md) · [internal/authority/fixtruntime/runtime.go](internal/authority/fixtruntime/runtime.go) · [docs/01-compliance/sources.md](docs/01-compliance/sources.md) | RM-FE-001 (real AGT); mock parcial RM-FEFIX-007/008 | 3 ops mock + fila SQL + runtime admin; wire/registo/séries AGT bloqueados |
| [ ] | RM-FE-004 | Processamento assíncrono, FE-RNG, retries, reconciliação | EM_CURSO | [docs/01-compliance/agt-fe-fixture-queue.md](docs/01-compliance/agt-fe-fixture-queue.md) · [internal/authority/fixtruntime/runtime.go](internal/authority/fixtruntime/runtime.go) · [docs/01-compliance/requirements-catalog.md](docs/01-compliance/requirements-catalog.md) | RM-FE-001 (real AGT); mock parcial RM-FEFIX-007/008 | Worker runtime + retries mock; ≠ reconciliação AGT |
...
| [x] | RM-FEFIX-003 | JWS genérico + perfis só para ops com campos inequivocamente documentados | CONCLUÍDO | https://github.com/storesace-cv/bwb-modulo-fiscal/pull/159 · [internal/fejws/compact.go](internal/fejws/compact.go) · [internal/feprofile/profiles.go](internal/feprofile/profiles.go) · [compliance/derived/requirements/FE-JWS-PROFILES-MATRIX-RM-FEFIX-003.md](compliance/derived/requirements/FE-JWS-PROFILES-MATRIX-RM-FEFIX-003.md) · [docs/01-compliance/agt-clarifications-register.md](docs/01-compliance/agt-clarifications-register.md) · [CHANGELOG.md](CHANGELOG.md) · 2026-08-16 | RM-FEFIX-002 | motor+matriz+fail-closed; **0** perfis wire AGT (C-FE-JWS-TYP-001); payload builders ≠ aceite AGT; fontes pending_validation |
...
| [x] | RM-FEFIX-008 | Runtime fiscal-api: worker fila fixture + admin enqueue/process | CONCLUÍDO | https://github.com/storesace-cv/bwb-modulo-fiscal/pull/167 · [docs/01-compliance/agt-fe-fixture-queue.md](docs/01-compliance/agt-fe-fixture-queue.md) · [internal/authority/fixtruntime/runtime.go](internal/authority/fixtruntime/runtime.go) · [cmd/fiscal-api/main.go](cmd/fiscal-api/main.go) · [CHANGELOG.md](CHANGELOG.md) · 2026-08-19 | RM-FEFIX-007 | Operador usa workbook via serviço mock-only; **≠** wire AGT / AGT-Q-003 |
| [x] | RM-FEFIX-007 | Fila SQL workbook→boundary mock + retries + admin metadados + E2E CI | CONCLUÍDO | https://github.com/storesace-cv/bwb-modulo-fiscal/pull/165 · [internal/authority/fefixqueue/doc.go](internal/authority/fefixqueue/doc.go) · [docs/01-compliance/agt-fe-fixture-queue.md](docs/01-compliance/agt-fe-fixture-queue.md) · [migrations/postgres/0014_fe_fixture_submissions.up.sql](migrations/postgres/0014_fe_fixture_submissions.up.sql) · [CHANGELOG.md](CHANGELOG.md) · 2026-08-19 | RM-FEFIX-006 | Persistência + worker mock; FISCAL_AGT_TEST_WORKBOOK; fixture_boundary_* ≠ AGT; wire bloqueado |
...
| [x] | RM-AGTPREP-014 | SecretStore durável cifrado em repouso (SQL + master key externa; HML/PRD fail-closed) | CONCLUÍDO | https://github.com/storesace-cv/bwb-modulo-fiscal/pull/146 · [internal/secretstore/sqlstore.go](internal/secretstore/sqlstore.go) · [internal/secretstore/open.go](internal/secretstore/open.go) · [migrations/postgres/0013_secret_store_entries.up.sql](migrations/postgres/0013_secret_store_entries.up.sql) · [deploy/postgres/grants-schema13-runtime-admin.sql](deploy/postgres/grants-schema13-runtime-admin.sql) · [CHANGELOG.md](CHANGELOG.md) · 2026-07-29 | RM-SECADM-002 + RM-AGTPREP-004 | Ciphertext-only; write-only; ≠ AGT/KMS; ExpectedVersion=13 |
| [x] | RM-AGTPREP-015 | Hub owner-only preparação AGT + catálogo endpoints FE + scaffold JWS | CONCLUÍDO | https://github.com/storesace-cv/bwb-modulo-fiscal/pull/147 · [internal/adminui/agt_settings_ui.go](internal/adminui/agt_settings_ui.go) · [internal/authority/prep/endpoint_catalog.go](internal/authority/prep/endpoint_catalog.go) · [internal/adminapi/authority_catalog_handlers.go](internal/adminapi/authority_catalog_handlers.go) · [specs/admin/openapi.yaml](specs/admin/openapi.yaml) · [CHANGELOG.md](CHANGELOG.md) · 2026-07-29 | RM-AGTPREP-014 + RM-AGTPREP-003 + DEC-BO-004 | C-FE-001 fail-closed; claims pending_external; ≠ AGT |
| [x] | RM-AGTPREP-016 | Inventário mascarado SecretStore por ambiente (owner hub + API) | CONCLUÍDO | https://github.com/storesace-cv/bwb-modulo-fiscal/pull/148 · [internal/secretstore/secretstore.go](internal/secretstore/secretstore.go) · [internal/adminapi/ops_handlers.go](internal/adminapi/ops_handlers.go) · [internal/adminui/agt_settings_ui.go](internal/adminui/agt_settings_ui.go) · [specs/admin/openapi.yaml](specs/admin/openapi.yaml) · [CHANGELOG.md](CHANGELOG.md) · 2026-07-29 | RM-AGTPREP-014 + RM-AGTPREP-015 | ListMetadata HML≠PRD; sem plaintext; OpenAPI 0.1.30 |
| [x] | RM-AGTPREP-017 | Estado conectividade preparação AGT no hub owner (último probe audit) | CONCLUÍDO | https://github.com/storesace-cv/bwb-modulo-fiscal/pull/149 · [internal/authority/prep/connectivity.go](internal/authority/prep/connectivity.go) · [internal/adminapi/authority_connectivity_handlers.go](internal/adminapi/authority_connectivity_handlers.go) · [internal/adminui/agt_settings_ui.go](internal/adminui/agt_settings_ui.go) · [specs/admin/openapi.yaml](specs/admin/openapi.yaml) · [CHANGELOG.md](CHANGELOG.md) · 2026-07-29 | RM-AGTPREP-006 + RM-AGTPREP-015 | external_verified=false; simulator≠AGT; OpenAPI 0.1.31 |
| [x] | RM-AGTPREP-018 | Validação bindings AuthorityProfile (C-FE-001 + refs SecretStore presentes) | CONCLUÍDO | https://github.com/storesace-cv/bwb-modulo-fiscal/pull/150 · [internal/authority/prep/binding_validate.go](internal/authority/prep/binding_validate.go) · [internal/adminapi/authority_binding_handlers.go](internal/adminapi/authority_binding_handlers.go) · [specs/admin/openapi.yaml](specs/admin/openapi.yaml) · [CHANGELOG.md](CHANGELOG.md) · 2026-07-29 | RM-AGTPREP-014…017 + C-FE-001 | secrets_ready exige 3 refs; ops conflict_open recusadas; ≠ AGT |
| [x] | RM-AGTPREP-019 | UI readiness owner: bindings_valid + issues (C-FE-001/refs) | CONCLUÍDO | [internal/adminui/authority_ui.go](internal/adminui/authority_ui.go) · [internal/adminui/templates/authority_readiness.html](internal/adminui/templates/authority_readiness.html) · [CHANGELOG.md](CHANGELOG.md) · 2026-07-29 | RM-AGTPREP-018 + RM-BO-011 | Sem plaintext; checklist exige bindings_valid |
| [x] | RM-AGTPREP-020 | Hub owner: probe simulador (CSRF) + bindings por perfil | CONCLUÍDO | https://github.com/storesace-cv/bwb-modulo-fiscal/pull/152 · [internal/adminui/agt_settings_ui.go](internal/adminui/agt_settings_ui.go) · [internal/adminui/templates/agt_settings.html](internal/adminui/templates/agt_settings.html) · [CHANGELOG.md](CHANGELOG.md) · 2026-07-29 | RM-AGTPREP-017…019 | Fail-closed prod+simulator; audit; ≠ AGT/plaintext |
| [x] | RM-AGTPREP-021 | Estado sanitizado SecretStore/master key (hub + API owner) | CONCLUÍDO | https://github.com/storesace-cv/bwb-modulo-fiscal/pull/153 · [internal/secretstore/vault_status.go](internal/secretstore/vault_status.go) · [internal/adminapi/authority_secretstore_status_handlers.go](internal/adminapi/authority_secretstore_status_handlers.go) · [specs/admin/openapi.yaml](specs/admin/openapi.yaml) · [CHANGELOG.md](CHANGELOG.md) · 2026-07-29 | RM-AGTPREP-014 + RM-AGTPREP-015 | Fingerprint SHA-256; ready_for_homologation≠AGT; OpenAPI 0.1.33 |
| [x] | RM-AGTPREP-022 | SecAdm gate present/absent no hub AGT + allowlist OWNER_SUBJECT | CONCLUÍDO | [internal/adminapi/authority_secadm_gate_handlers.go](internal/adminapi/authority_secadm_gate_handlers.go) · [deploy/env.allowlist](deploy/env.allowlist) · [specs/admin/openapi.yaml](specs/admin/openapi.yaml) · [CHANGELOG.md](CHANGELOG.md) · 2026-07-29 | RM-SECADM-001 + RM-AGTPREP-015 | Sem subject/plaintext; OpenAPI 0.1.34; ≠ AGT |
