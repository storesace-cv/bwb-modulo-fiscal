...
| [ ] | RM-REQ-001 | Requisitos AO-* confirmados a partir de fontes oficiais | EM_CURSO | [compliance/derived/requirements/PROVISIONAL-MATRIX-RM-REQ-001.md](compliance/derived/requirements/PROVISIONAL-MATRIX-RM-REQ-001.md) · [docs/01-compliance/requirements-catalog.md](docs/01-compliance/requirements-catalog.md) | RM-SRC-005 feito; RM-SRC-004 BLOQUEADO (Rect. 10/19); revisão compliance | Matriz AO-* rastreável; AO-SEQ-002 + AO-ID-001 `partial` (DE 683, não confirmado); Rect.-dependent `blocked` |
