...
| [ ] | RM-SAFT-001 | Fundação estrutural gerador SAF-T AO (tipos/mapeamento a partir do XSD; ≠ conformidade) | PENDENTE | [docs/01-compliance/saft-ao.md](docs/01-compliance/saft-ao.md) · [compliance/saft-ao/schemas/SAFTAO1.01_01.xsd](compliance/saft-ao/schemas/SAFTAO1.01_01.xsd) | RM-SRC-005 | Pacote tipos + skeleton; sem alegar AO-* / certificação |
...
| [ ] | RM-UI-005 | Sessão browser Secure+HttpOnly+SameSite + CSRF + logout (sem token no browser) | PENDENTE | [docs/02-architecture/backoffice-architecture.md](docs/02-architecture/backoffice-architecture.md) | RM-BO-006 + RM-UI-001 | Cookie de sessão servidor; OIDC code/BFF; sem localStorage de JWT |
| [ ] | RM-BO-007 | Observabilidade/operabilidade do backoffice (métricas/health/audit ops) | PENDENTE | [docs/02-architecture/backoffice-architecture.md](docs/02-architecture/backoffice-architecture.md) | RM-BO-001 + RM-UI-001 | Sem AGT; sem deploy |
