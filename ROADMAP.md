...
| [ ] | RM-OPS-008 | Fundação SMTP segura (implicit TLS 465; smtp.env 0600; teste owner-only; fake TLS nos testes) | EM_CURSO | [docs/07-operations/smtp-notifications.md](docs/07-operations/smtp-notifications.md) · [internal/notify/smtp/smtp.go](internal/notify/smtp/smtp.go) · [deploy/smtp.env.allowlist](deploy/smtp.env.allowlist) | RM-OPS-007 + RM-BO-004 | Port 465; sem passwords no email; DeliveryStatus sanitizado; helper smtp-send-test |
