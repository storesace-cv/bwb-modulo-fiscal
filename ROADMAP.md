...
| [ ] | RM-REQ-001 | Requisitos AO-* confirmados a partir de fontes oficiais | EM_CURSO | [compliance/derived/requirements/PROVISIONAL-MATRIX-RM-REQ-001.md](compliance/derived/requirements/PROVISIONAL-MATRIX-RM-REQ-001.md) · [compliance/derived/requirements/DOCUMENT-TYPES-MATRIX-RM-REQ-001.md](compliance/derived/requirements/DOCUMENT-TYPES-MATRIX-RM-REQ-001.md) · [docs/01-compliance/requirements-catalog.md](docs/01-compliance/requirements-catalog.md) | citação página a página + revisão compliance; DEC-REG-003 | DP71+DE74/Rect citados; OFF-002 `partial`; C-SIGN-001; DOC-001/`TAX` `scaffold`; sem confirmados |
