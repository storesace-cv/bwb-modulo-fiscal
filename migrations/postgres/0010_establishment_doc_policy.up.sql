...
CREATE TABLE fiscal.establishment_doc_group_config (
...
CREATE TABLE fiscal.establishment_doc_type_config (
  establishment_id TEXT NOT NULL REFERENCES fiscal.establishments (establishment_id) ON DELETE RESTRICT,
  environment TEXT NOT NULL,
...
CREATE INDEX establishment_doc_group_config_est_idx
  ON fiscal.establishment_doc_group_config (establishment_id);
CREATE INDEX establishment_doc_type_config_est_idx
  ON fiscal.establishment_doc_type_config (establishment_id);
