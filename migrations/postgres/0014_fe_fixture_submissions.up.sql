...
-- States fixture_boundary_* only; NEVER authority_accepted / homologação AGT.

CREATE TABLE fiscal.fe_fixture_submissions (
...
CREATE INDEX fe_fixture_submissions_claim_idx ON fiscal.fe_fixture_submissions (state, next_attempt_at);
