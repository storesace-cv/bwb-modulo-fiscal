...
CREATE INDEX establishments_taxpayer_id_idx ON establishments (taxpayer_id);
CREATE INDEX scope_bindings_taxpayer_id_idx ON scope_bindings (taxpayer_id);
CREATE INDEX scope_bindings_establishment_id_idx ON scope_bindings (establishment_id);
